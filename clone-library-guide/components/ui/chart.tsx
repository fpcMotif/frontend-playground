...
function generateChartStyles(id: string, config: ChartConfig): string {
...
function getTooltipItemProps(
  ...
  return { key, itemConfig, indicatorColor };
}
...
function TooltipItemContent({
  ...
  item: TooltipPayloadItem;
  itemConfig?: { label?: ReactNode; icon?: ComponentType };
  nestLabel: boolean;
...
function TooltipItem({
  ...
  const { itemConfig, indicatorColor } = getTooltipItemProps(
    item,
    nameKey,
    config,
    color
