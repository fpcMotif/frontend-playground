(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	"[project]/react-project-conversion/node_modules/next/dist/compiled/react-server-dom-turbopack/cjs/react-server-dom-turbopack-client.browser.development.js [app-client] (ecmascript)",
		...
		"production" !== ("TURBOPACK compile-time value", "development") &&
			(() => {
				...
				function requireAsyncModule(id) {
					var promise =
						/*TURBOPACK member replacement*/ __turbopack_context__.r(id);
					if (
				...
				function preloadModule(metadata) {
					for (
						...
						var thenable =
							/*TURBOPACK member replacement*/ __turbopack_context__.L(
								chunks[i],
							);
				...
				function requireModule(metadata) {
					var moduleExports =
						/*TURBOPACK member replacement*/ __turbopack_context__.r(
							metadata[0],
						);
						...
						if (jsxPropsParents.has(objectOrArray)) {
							...
							for (i = 0; i < type.length; i++) {
								...
								value === expandedName
									...
									: (objKind =
											10 > _substr2.length &&
											40 > objKind.length + _substr2.length
												? objKind + _substr2
												: objKind + "...");
							}
							objKind += ">";
							...
							for (i = 0; i < type.length; i++)
								0 < i && (objKind += ", "),
									...
									value === expandedName
										...
										: (objKind =
												10 > _value2.length &&
												40 > objKind.length + _value2.length
													? objKind + _value2
													: objKind + "...");
							objKind += "}";
						}
					...
					function action() {
						...
						return bound
							? "fulfilled" === bound.status
								...
								: Promise.resolve(bound).then((boundArgs) =>
										callServer(id, boundArgs.concat(args)),
									)
							: callServer(id, args);
					}
					var id = metaData.id,
						...
						case "object":
							if (null === value) {
								...
								if (value.$$typeof === REACT_ELEMENT_TYPE) {
									var typeName =
											getComponentNameFromType(value.type) || "\u2026",
										key = value.key;
									value = value.props;
					...
					try {
						switch (typeof value) {
							...
							case "object": {
								...
								if ("string" === typeof value.currentSrc)
					...
					if (code.startsWith("async function")) {
						...
						if (-1 !== idx)
							return (
								...
								(0, eval)(
									"({" + JSON.stringify(code) + ":async function(){}})",
								)[code]
							);
				...
				function incrementChunkDebugInfo(streamState, chunkLength) {
					...
					endTime > previousEndTime + 10
						? ((streamState._debugInfo = {
							...
							(streamState._debugTargetChunkSize =
						...
						if (
							...
							if (null != chunk._debugChunk) {
								...
								try {
									...
									(initializingHandler = streamState),
										(initializingChunk = chunks);
								}
							}
							chunk.status = "fulfilled";
							chunk.value = stream;
				...
				function flushComponentPerformance(
					...
					if (debugInfo) {
						...
						for (var _i4 = debugInfo.length - 1; 0 <= _i4; _i4--) {
							...
							if (
								"number" === typeof _info.time &&
								_info.time > parentEndTime
							) {
											...
											if (
												...
												if (supportsUserTiming) {
													...
													performance.measure(measureName, {
														start:
															0 > startTime$jscomp$2 ? 0 : startTime$jscomp$2,
															...
															0.5 > selfTime
																...
																: 50 > selfTime
																	...
																	: 500 > selfTime
																		...
																		: "error",
														debugTask$jscomp$0 =
															componentInfo$jscomp$3.debugTask,
												...
												switch (thenable.status) {
													...
													case "rejected": {
														...
														if (supportsUserTiming && 0 < endTime$jscomp$0) {
															var description =
																	getIODescription(error$jscomp$0),
																entryName$jscomp$1 =
																	"await " +
																	getIOShortName(
										...
										if ("string" === typeof _candidateInfo.name) {
											...
											if (supportsUserTiming) {
												...
												performance.measure(measureName$jscomp$1, {
													start:
														0 > startTime$jscomp$5 ? 0 : startTime$jscomp$5,
								...
								b: {
									...
									if (null !== initializingHandler) {
										...
										if (owner.errored) {
											...
											supportsCreateTask &&
												(owner.debugTask = value._debugTask);
				...
				function createResponseFromOptions(options) {
					...
					return new ResponseInstance(
						...
						options && options.environmentName
				...
				function startReadingFromUniversalStream(
					...
					function progress(_ref) {
						...
						if (value instanceof ArrayBuffer)
							...
							if (
								((_ref = streamState),
								void 0 !== response$jscomp$0.weak.deref())
							) {
				...
				var debugChannelRegistry =
					...
					createFakeJSXCallStack = {
						react_stack_bottom_frame: (response, stack, environmentName) =>
							buildFakeCallStack(
								response,
								stack,
								environmentName,
					...
					replayConsoleWithCallStack = {
						react_stack_bottom_frame: (response, payload) => {
							...
							currentOwnerInDEV =
								null === owner ? response._debugRootOwner : owner;
							try {
								a: {
									var offset = 0;
									switch (methodName) {
				...
				((internals) => {
					...
					getCurrentComponentInfo: () => currentOwnerInDEV,
				});
				exports.createFromFetch = (promiseForResponse, options) => {
				...
				exports.createFromReadableStream = (stream, options) => {
					var response = createResponseFromOptions(options);
					if (
						options &&
						options.debugChannel &&
				...
				exports.createTemporaryReferenceSet = () => new Map();
				exports.encodeReply = (value, options) =>
				...
				exports.registerServerReference = (reference, id) => {
					registerBoundServerReference(reference, id, null);
					return reference;
				};
			})();
	},
	"[project]/react-project-conversion/node_modules/next/dist/compiled/react-server-dom-turbopack/client.browser.js [app-client] (ecmascript)",
	(__turbopack_context__, module, exports) => {
		"use strict";
...
//# sourceMappingURL=f34e2_next_dist_compiled_react-server-dom-turbopack_3b64edee._.js.map
